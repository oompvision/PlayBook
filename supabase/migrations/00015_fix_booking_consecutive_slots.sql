-- ============================================================
-- Fix: create_booking now groups non-consecutive slots into
-- separate bookings instead of merging them into one span.
-- e.g. selecting 2-3 PM and 6-7 PM creates TWO bookings,
-- not one 2-7 PM booking.
-- ============================================================

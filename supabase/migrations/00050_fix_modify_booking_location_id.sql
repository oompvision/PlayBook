-- ============================================================
-- 50. Fix modify_booking and modify_guest_booking to include location_id
-- Both functions were missing location_id in their INSERT, causing
-- NOT NULL constraint violations after migration 00034.
-- ============================================================

-- Fix modify_booking (registered customers)
...
BEGIN
  ...
  SELECT id, org_id, customer_id, bay_id, date, start_time, end_time,
         total_price_cents, status, confirmation_code, is_guest, location_id
  INTO v_old_booking
  ...
  INSERT INTO public.bookings (
    ...
    status, confirmation_code, notes, modified_from, location_id
  ) VALUES (
    v_old_booking.org_id, v_old_booking.customer_id, p_new_bay_id, p_new_date,
    v_start_time, v_end_time, v_total_price,
    'confirmed', v_confirmation_code, p_notes, p_booking_id, v_old_booking.location_id
...
BEGIN
  ...
  SELECT id, org_id, customer_id, bay_id, date, start_time, end_time,
         ...
         guest_name, guest_email, guest_phone, location_id
  INTO v_old_booking
  FROM public.bookings
  WHERE id = p_booking_id;
  ...
  INSERT INTO public.bookings (
    ...
    p_booking_id, v_old_booking.location_id
  ) RETURNING id INTO v_new_booking_id;
